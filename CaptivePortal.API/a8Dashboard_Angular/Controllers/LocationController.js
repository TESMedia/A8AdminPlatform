...
a8DashboardModule.controller('LocationController', ['$scope', 'LocationService', '$rootScope', 'Notification', function ($scope, LocationService, $rootScope, Notification) {
    ...
    $scope.GenerateReport = function () {
        ...
        if (!chkSelectedElementValue) {
        ...
        else if (!document.getElementById('ddlSites').value) {
            ...
            var item = { Location: chkSelectedElementValue.value, Day: $scope.SelectDate, FromHour: $scope.FromHour, ToHour: $scope.ToHour, DwellTime: $scope.DwellTime, ConnectionName: document.getElementById('ddlSites').value }
